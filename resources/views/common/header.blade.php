<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">M-zl</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">B-blog</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">{{Session::get('name')}}</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
		
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li>
						<a href="">
							<img src="{{Session::get('head_img')}}" class="round" style="width: 35px;height: 35px; border-radius: 70px;" >
						</a>
					</li>
					<li class="dropDown dropDown_hover"> <a href="/AdminUsers/information" class="dropDown_A">{{Session::get('name')}}<i class="Hui-iconfont"></i></a>
						<ul class="dropDown-menu menu radius box-shadow" >
							...
							<li><a href="/logout" style="color:#000">退出</a></li>
